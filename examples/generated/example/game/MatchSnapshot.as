...
package example.game
{
    ...
    public final class MatchSnapshot
    {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:example.game.MatchSnapshot = null, limit:uint = 0, reset:Boolean = true):example.game.MatchSnapshot
        {
            if (!dst)
            ...
            try
            {
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case 16:
                        {
                            dst.state = Unpack.readInt32(src);
                            break;
                        }
                        case 26:
                        {
                            ...
                            if (messageLength !== 0)
                                example.game.Player.deserializeMemory(src, msgPlayers, src.position + messageLength);
