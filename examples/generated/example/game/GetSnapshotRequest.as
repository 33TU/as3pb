...
package example.game
{
    ...
    public final class GetSnapshotRequest
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:example.game.GetSnapshotRequest, length:uint, reset:Boolean = true):example.game.GetSnapshotRequest
        {
            if (!dst)
