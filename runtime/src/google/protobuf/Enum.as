...
package google.protobuf
{
    ...
    public final class Enum
    {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.Enum = null, limit:uint = 0, reset:Boolean = true):google.protobuf.Enum
        {
            if (!dst)
                ...
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case 18:
                        {
                            ...
                            if (messageLength !== 0)
                                google.protobuf.EnumValue.deserializeMemory(src, msgEnumvalue, src.position + messageLength);
