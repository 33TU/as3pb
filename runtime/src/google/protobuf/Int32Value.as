...
package google.protobuf
{
    ...
    public final class Int32Value
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.Int32Value, length:uint, reset:Boolean = true):google.protobuf.Int32Value
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.Int32Value, length:uint, reset:Boolean = true):google.protobuf.Int32Value
        {
            if (!dst)
                dst = new google.protobuf.Int32Value();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.Int32Value, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localValue)
            {
                ...
                Pack.writeInt32(dst, localValue);
            }
