...
package google.protobuf
{
    ...
    public final class ListValue
    {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.ListValue = null, limit:uint = 0, reset:Boolean = true):google.protobuf.ListValue
        {
            if (!dst)
                ...
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        case 10:
                        {
                            ...
                            if (messageLength !== 0)
                                google.protobuf.Value.deserializeMemory(src, msgValues, src.position + messageLength);
