...
package google.protobuf
{
    ...
    public final class DoubleValue
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.DoubleValue, length:uint, reset:Boolean = true):google.protobuf.DoubleValue
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.DoubleValue, length:uint, reset:Boolean = true):google.protobuf.DoubleValue
        {
            if (!dst)
                dst = new google.protobuf.DoubleValue();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.DoubleValue, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localValue != 0.0)
            {
                Pack.writeByte(dst, 9);
                Pack.writeDouble(dst, localValue);
            }
