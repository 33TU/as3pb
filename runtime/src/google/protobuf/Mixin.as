...
package google.protobuf
{
    ...
    public final class Mixin
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.Mixin, length:uint, reset:Boolean = true):google.protobuf.Mixin
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.Mixin, length:uint, reset:Boolean = true):google.protobuf.Mixin
        {
            if (!dst)
                dst = new google.protobuf.Mixin();
            else if (reset)
            ...
            try
            {
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case 18:
                        {
                            dst.root = Unpack.readString(src);
                            break;
                        }
                        default:
                        {
         ...
         */
        public static function serializeMemory(src:google.protobuf.Mixin, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localRoot)
            {
                ...
                Pack.writeString(dst, localRoot);
            }
