...
package google.protobuf
{
    ...
    public final class BoolValue
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.BoolValue, length:uint, reset:Boolean = true):google.protobuf.BoolValue
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.BoolValue, length:uint, reset:Boolean = true):google.protobuf.BoolValue
        {
            if (!dst)
                dst = new google.protobuf.BoolValue();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.BoolValue, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localValue)
            {
                ...
                Pack.writeByte(dst, localValue ? 1 : 0);
            }
