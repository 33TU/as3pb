...
package google.protobuf
{
    ...
    public final class Timestamp
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.Timestamp, length:uint, reset:Boolean = true):google.protobuf.Timestamp
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.Timestamp, length:uint, reset:Boolean = true):google.protobuf.Timestamp
        {
            if (!dst)
                dst = new google.protobuf.Timestamp();
            else if (reset)
            ...
            try
            {
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        case 8:
                        {
                            Unpack.readVarint64s(src, dst.seconds);
                            break;
                        }
                        case 16:
                        {
                            dst.nanos = Unpack.readInt32(src);
                            break;
                        }
                        default:
                        {
         ...
         */
        public static function serializeMemory(src:google.protobuf.Timestamp, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localSeconds.low || localSeconds.high)
            {
                ...
                Pack.writeVarint64s(dst, localSeconds.low, localSeconds.high);
            }
            if (localNanos)
            {
                Pack.writeByte(dst, 16);
                Pack.writeInt32(dst, localNanos);
            }
