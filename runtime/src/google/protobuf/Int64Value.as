...
package google.protobuf
{
    ...
    public final class Int64Value
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.Int64Value, length:uint, reset:Boolean = true):google.protobuf.Int64Value
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.Int64Value, length:uint, reset:Boolean = true):google.protobuf.Int64Value
        {
            if (!dst)
                dst = new google.protobuf.Int64Value();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.Int64Value, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localValue.low || localValue.high)
            {
                ...
                Pack.writeVarint64s(dst, localValue.low, localValue.high);
            }
