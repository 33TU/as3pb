...
package google.protobuf
{
    ...
    public final class StructFieldsEntry
    {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.StructFieldsEntry = null, limit:uint = 0, reset:Boolean = true):google.protobuf.StructFieldsEntry
        {
            if (!dst)
                ...
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case 18:
                        {
                            ...
                            dst.value = google.protobuf.Value.deserializeMemory(src, dst.value, src.position + messageLength, false);
                            break;
                        }
                        default:
                        {
