...
package google.protobuf
{
    ...
    public final class Any
    {
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.Any, length:uint, reset:Boolean = true):google.protobuf.Any
        {
            if (!dst)
                dst = new google.protobuf.Any();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.Any, dst:PackContext):void
        {
            if (!src)
                return;
