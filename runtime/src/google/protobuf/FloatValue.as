...
package google.protobuf
{
    ...
    public final class FloatValue
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.FloatValue, length:uint, reset:Boolean = true):google.protobuf.FloatValue
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.FloatValue, length:uint, reset:Boolean = true):google.protobuf.FloatValue
        {
            if (!dst)
                dst = new google.protobuf.FloatValue();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.FloatValue, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localValue != 0.0)
            {
                Pack.writeByte(dst, 13);
                Pack.writeFloat(dst, localValue);
            }
