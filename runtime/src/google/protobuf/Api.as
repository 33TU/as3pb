...
package google.protobuf
{
    ...
    public final class Api
    {
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.Api, length:uint, reset:Boolean = true):google.protobuf.Api
        {
            if (!dst)
                dst = new google.protobuf.Api();
            else if (reset)
            ...
            try
            {
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case 18:
                        {
                            dst.methods.push(google.protobuf.Method.deserializeMemory(src, null, Unpack.readVarint32(src)));
                            break;
                        }
                        case 26:
                        {
                        ...
                        case 34:
                        {
                            dst.version = Unpack.readString(src);
                            break;
                        }
                        case 42:
                        {
                        ...
                        case 50:
                        {
                            dst.mixins.push(google.protobuf.Mixin.deserializeMemory(src, null, Unpack.readVarint32(src)));
                            break;
                        }
                        case 56:
                        {
         ...
         */
        public static function serializeMemory(src:google.protobuf.Api, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if ((vecLength = localMethods.length) !== 0)
            {
                for (vecIndex = 0; vecIndex < vecLength; vecIndex++)
                {
                    ...
                    google.protobuf.Method.serializeMemory(localMethods[vecIndex], dst);
            ...
            if (localVersion)
            {
                ...
                Pack.writeString(dst, localVersion);
            }
            if (localSourceContext)
            {
            ...
            if ((vecLength = localMixins.length) !== 0)
            {
                for (vecIndex = 0; vecIndex < vecLength; vecIndex++)
                {
                    ...
                    messageStart = Pack.startMessage(dst);
                    google.protobuf.Mixin.serializeMemory(localMixins[vecIndex], dst);
                    Pack.endMessage(dst, messageStart);
                }
            }
            if (localSyntax)
