...
package google.protobuf
{
    ...
    public final class UInt32Value
    {
         ...
         */
        [Inline]
        public static function reset(msg:google.protobuf.UInt32Value):void
        {
            msg.value = 0;
         ...
         */
        public static function clone(src:google.protobuf.UInt32Value):google.protobuf.UInt32Value
        {
            if (!src)
                return null;

            const dst:google.protobuf.UInt32Value = new google.protobuf.UInt32Value();
            dst.value = src.value;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.UInt32Value, length:uint, reset:Boolean = true):google.protobuf.UInt32Value
        {
            if (!dst)
                dst = new google.protobuf.UInt32Value();
            else if (reset)
                google.protobuf.UInt32Value.reset(dst);
         ...
         */
        public static function serializeBytes(src:google.protobuf.UInt32Value, dst:ByteArray):void
        {
            if (!src)
                return;
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.UInt32Value, length:uint, reset:Boolean = true):google.protobuf.UInt32Value
        {
            if (!dst)
                dst = new google.protobuf.UInt32Value();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.UInt32Value, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localValue)
            {
                ...
                Pack.writeVarint32(dst, localValue);
            }
