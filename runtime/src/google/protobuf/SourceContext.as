...
package google.protobuf
{
    ...
    public final class SourceContext
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.SourceContext, length:uint, reset:Boolean = true):google.protobuf.SourceContext
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.SourceContext, length:uint, reset:Boolean = true):google.protobuf.SourceContext
        {
            if (!dst)
                dst = new google.protobuf.SourceContext();
            else if (reset)
         ...
         */
        public static function serializeMemory(src:google.protobuf.SourceContext, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if (localFileName)
            {
                ...
                Pack.writeString(dst, localFileName);
            }
