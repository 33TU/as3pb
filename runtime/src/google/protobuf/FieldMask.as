...
package google.protobuf
{
    ...
    public final class FieldMask
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:google.protobuf.FieldMask, length:uint, reset:Boolean = true):google.protobuf.FieldMask
        {
            if (!dst)
         ...
         * @param reset Whether to reset a reusable destination before decoding.
         */
        public static function deserializeMemory(src:UnpackContext, dst:google.protobuf.FieldMask, length:uint, reset:Boolean = true):google.protobuf.FieldMask
        {
            if (!dst)
                dst = new google.protobuf.FieldMask();
            else if (reset)
            ...
            try
            {
                ...
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        case 10:
                        {
                            dst.paths.push(Unpack.readString(src));
                            break;
                        }
                        default:
                        {
         ...
         */
        public static function serializeMemory(src:google.protobuf.FieldMask, dst:PackContext):void
        {
            if (!src)
                return;
            ...
            if ((vecLength = localPaths.length) !== 0)
            {
                for (vecIndex = 0; vecIndex < vecLength; vecIndex++)
                {
                    ...
                    Pack.writeString(dst, localPaths[vecIndex]);
                }
            }
