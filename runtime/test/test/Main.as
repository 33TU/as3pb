package test
{
    ...
    public final class Main extends Sprite
    {
        public function Main()
        {
            ...
            runTest("testPackedAppend", testPackedAppend);
        ...
        private static function testPackedAppend():void
        {
            const out0:Vector.<uint> = new Vector.<uint>();
            const bytes0:ByteArray = Buffers.newByteArray();
            bytes0.writeByte(4);
            bytes0.writeUnsignedInt(10);
            bytes0.writeByte(0);
            bytes0.writeByte(20);
            bytes0.writeUnsignedInt(10);
            bytes0.writeUnsignedInt(11);
            bytes0.writeUnsignedInt(12);
            bytes0.writeUnsignedInt(13);
            bytes0.writeUnsignedInt(14);
            bytes0.position = 0;
            Deserialize.readFixed32Vector(bytes0, out0);
            Deserialize.readFixed32Vector(bytes0, out0);
            Deserialize.readFixed32Vector(bytes0, out0);
            assertEq("Fixed32 packed append length", out0.length, 6);
            assertEq("Fixed32 first", out0[0], 10);
            assertEq("Fixed32 last", out0[5], 14);
            const out1:Vector.<int> = new Vector.<int>();
            const bytes1:ByteArray = Buffers.newByteArray();
            bytes1.writeByte(4);
            bytes1.writeInt(10);
            bytes1.writeByte(0);
            bytes1.writeByte(20);
            ...
            bytes1.writeInt(14);
            bytes1.position = 0;
            Deserialize.readFixed32sVector(bytes1, out1);
            Deserialize.readFixed32sVector(bytes1, out1);
            Deserialize.readFixed32sVector(bytes1, out1);
            assertEq("Fixed32s packed append length", out1.length, 6);
            assertEq("Fixed32s first", out1[0], 10);
            assertEq("Fixed32s last", out1[5], 14);
            const out2:Vector.<Number> = new Vector.<Number>();
            const bytes2:ByteArray = Buffers.newByteArray();
            bytes2.writeByte(4);
            bytes2.writeFloat(10);
            bytes2.writeByte(0);
            bytes2.writeByte(20);
            bytes2.writeFloat(10);
            bytes2.writeFloat(11);
            bytes2.writeFloat(12);
            bytes2.writeFloat(13);
            bytes2.writeFloat(14);
            bytes2.position = 0;
            Deserialize.readFloatVector(bytes2, out2);
            Deserialize.readFloatVector(bytes2, out2);
            Deserialize.readFloatVector(bytes2, out2);
            assertEq("Float packed append length", out2.length, 6);
            assertEq("Float first", out2[0], 10);
            assertEq("Float last", out2[5], 14);
            const out3:Vector.<Number> = new Vector.<Number>();
            const bytes3:ByteArray = Buffers.newByteArray();
            bytes3.writeByte(8);
            bytes3.writeDouble(10);
            bytes3.writeByte(0);
            bytes3.writeByte(40);
            bytes3.writeDouble(10);
            bytes3.writeDouble(11);
            bytes3.writeDouble(12);
            bytes3.writeDouble(13);
            bytes3.writeDouble(14);
            bytes3.position = 0;
            Deserialize.readDoubleVector(bytes3, out3);
            Deserialize.readDoubleVector(bytes3, out3);
            Deserialize.readDoubleVector(bytes3, out3);
            assertEq("Double packed append length", out3.length, 6);
            assertEq("Double first", out3[0], 10);
            assertEq("Double last", out3[5], 14);
            const out4:UInt64Vector = new UInt64Vector();
            const bytes4:ByteArray = Buffers.newByteArray();
            bytes4.writeByte(8);
            bytes4.writeUnsignedInt(10);
            bytes4.writeUnsignedInt(20);
            bytes4.writeByte(0);
            bytes4.writeByte(40);
            bytes4.writeUnsignedInt(10);
            bytes4.writeUnsignedInt(20);
            bytes4.writeUnsignedInt(11);
            bytes4.writeUnsignedInt(21);
            bytes4.writeUnsignedInt(12);
            bytes4.writeUnsignedInt(22);
            bytes4.writeUnsignedInt(13);
            bytes4.writeUnsignedInt(23);
            bytes4.writeUnsignedInt(14);
            bytes4.writeUnsignedInt(24);
            bytes4.position = 0;
            Deserialize.readFixed64Vector(bytes4, out4);
            Deserialize.readFixed64Vector(bytes4, out4);
            Deserialize.readFixed64Vector(bytes4, out4);
            assertEq("Fixed64 packed append length", out4.length, 6);
            assertEq("Fixed64 first low", out4.low[0], 10);
            assertEq("Fixed64 last high", out4.high[5], 24);
            const out5:Int64Vector = new Int64Vector();
            const bytes5:ByteArray = Buffers.newByteArray();
            bytes5.writeByte(8);
            bytes5.writeInt(10);
            bytes5.writeInt(20);
            bytes5.writeByte(0);
            ...
            bytes5.writeInt(24);
            bytes5.position = 0;
            Deserialize.readFixed64sVector(bytes5, out5);
            Deserialize.readFixed64sVector(bytes5, out5);
            Deserialize.readFixed64sVector(bytes5, out5);
            assertEq("Fixed64s packed append length", out5.length, 6);
            assertEq("Fixed64s first low", out5.low[0], 10);
            assertEq("Fixed64s last high", out5.high[5], 24);
        }
