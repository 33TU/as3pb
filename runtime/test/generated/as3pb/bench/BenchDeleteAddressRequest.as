...
package as3pb.bench
{
    ...
    public final class BenchDeleteAddressRequest
    {
         ...
         */
        [Inline]
        public static function reset(msg:BenchDeleteAddressRequest):void
        {
            msg.id = "";
        }
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:BenchDeleteAddressRequest = null, limit:uint = 0, reset:Boolean = true):BenchDeleteAddressRequest
        {
            if (!dst)
                dst = new BenchDeleteAddressRequest();
            else if (reset)
                BenchDeleteAddressRequest.reset(dst);
         ...
         */
        public static function serializeBytes(src:BenchDeleteAddressRequest, dst:ByteArray):void
        {
