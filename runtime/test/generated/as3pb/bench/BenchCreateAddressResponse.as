...
package as3pb.bench
{
    ...
    public final class BenchCreateAddressResponse
    {
         ...
         */
        [Inline]
        public static function reset(msg:BenchCreateAddressResponse):void
        {
            msg.success = false;
            msg.id = "";
        }
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:BenchCreateAddressResponse = null, limit:uint = 0, reset:Boolean = true):BenchCreateAddressResponse
        {
            if (!dst)
                dst = new BenchCreateAddressResponse();
            else if (reset)
                BenchCreateAddressResponse.reset(dst);
         ...
         */
        public static function serializeBytes(src:BenchCreateAddressResponse, dst:ByteArray):void
        {
