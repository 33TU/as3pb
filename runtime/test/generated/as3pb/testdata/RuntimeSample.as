                ...
                switch (tag)
                {
                    ...
                    case 50:
                    {
                        if ((msgLen = Deserialize.readVarint32(src)) !== 0)
                            dst.nested = RuntimeNested.deserializeBytes(src, dst.nested, src.position + msgLen, reset);
                        break;
                    }
                    case 58:
                    {
                        ...
                        if ((msgLen = Deserialize.readVarint32(src)) !== 0)
                            RuntimeNested.deserializeBytes(src, msgChildren, src.position + msgLen);
                    ...
                    case 82:
                    {
                        dst.choiceCase = 10;
                        if ((msgLen = Deserialize.readVarint32(src)) !== 0)
                            dst.selected = RuntimeNested.deserializeBytes(src, dst.selected, src.position + msgLen, reset);
                        break;
                    }
                    default:
                    {
